...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_site_url(); ?>/wp-content/themes/oceanwp/templates/dist/css/style.css">
        ...
        <div class="container">
            <div class="site-header-inner">
                <div class="brand header-brand">
                    <h1 class="m-0">
                        <a href="#">
                            <img class="header-logo-image" src="<?php echo get_site_url(); ?>/wp-content/themes/oceanwp/templates/dist/images/logo.svg" alt="Logo">
                        </a>
                    </h1>
                </div>
            </div>
                ...
                <div class="features-inner section-inner has-bottom-divider">
                    <div class="features-wrap">
                        <div class="feature text-center is-revealing">
                            <div class="feature-inner">
                                <div class="feature-icon">
                                    <img src="<?php echo get_site_url(); ?>/wp-content/themes/oceanwp/templates/dist/images/feature-icon-01.svg" alt="Feature 01">
                                </div>
                        ...
                        <div class="feature text-center is-revealing">
                            <div class="feature-inner">
                                <div class="feature-icon">
                                    <img src="<?php echo get_site_url(); ?>/wp-content/themes/oceanwp/templates/dist/images/feature-icon-02.svg" alt="Feature 02">
                                </div>
                                <h4 class="feature-title mt-24">Be Productive</h4>
                                <p class="text-sm mb-0">Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. A arcu cursus vitae congue mauris. Nam at lectus urna duis convallis. Mauris rhoncus aenean vel elit scelerisque mauris.</p>
                            </div>
                        ...
                        <div class="feature text-center is-revealing">
                            <div class="feature-inner">
                                <div class="feature-icon">
                                    <img src="<?php echo get_site_url(); ?>/wp-content/themes/oceanwp/templates/dist/images/feature-icon-03.svg" alt="Feature 03">
                                </div>
                                <h4 class="feature-title mt-24">Be Productive</h4>
                                <p class="text-sm mb-0">Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. A arcu cursus vitae congue mauris. Nam at lectus urna duis convallis. Mauris rhoncus aenean vel elit scelerisque mauris.</p>
                            </div>
                        ...
                        <div class="feature text-center is-revealing">
                            <div class="feature-inner">
                                <div class="feature-icon">
                                    <img src="<?php echo get_site_url(); ?>/wp-content/themes/oceanwp/templates/dist/images/feature-icon-04.svg" alt="Feature 04">
                                </div>
                                <h4 class="feature-title mt-24">Be Productive</h4>
                                <p class="text-sm mb-0">Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. A arcu cursus vitae congue mauris. Nam at lectus urna duis convallis. Mauris rhoncus aenean vel elit scelerisque mauris.</p>
                            </div>
                        ...
                        <div class="feature text-center is-revealing">
                            <div class="feature-inner">
                                <div class="feature-icon">
                                    <img src="<?php echo get_site_url(); ?>/wp-content/themes/oceanwp/templates/dist/images/feature-icon-05.svg" alt="Feature 05">
                                </div>
                                <h4 class="feature-title mt-24">Be Productive</h4>
                                <p class="text-sm mb-0">Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. A arcu cursus vitae congue mauris. Nam at lectus urna duis convallis. Mauris rhoncus aenean vel elit scelerisque mauris.</p>
                            </div>
                        ...
                        <div class="feature text-center is-revealing">
                            <div class="feature-inner">
                                <div class="feature-icon">
                                    <img src="<?php echo get_site_url(); ?>/wp-content/themes/oceanwp/templates/dist/images/feature-icon-06.svg" alt="Feature 06">
                                </div>
                                <h4 class="feature-title mt-24">Be Productive</h4>
                                <p class="text-sm mb-0">Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. A arcu cursus vitae congue mauris. Nam at lectus urna duis convallis. Mauris rhoncus aenean vel elit scelerisque mauris.</p>
                            </div>
...
<script src="<?php echo get_site_url(); ?>/wp-content/themes/oceanwp/templates/dist/js/main.min.js"></script>
<?php wp_footer(); ?>
</body>
</html>
